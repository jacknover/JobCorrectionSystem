...
<form  id="form1" name="form1" method="post" action="addTeacher">
 ...
 <table border="2px" style="border-radius:5px;solid;border-color:#ff7777#b40486#ff7777#b40486" align="center"width="40%" height="500px"
                background="">
         <div <caption style="margin-left:100px;color:blue;font-family:stcaiyun"><h1>添加教师</h1></caption>
...
<input type="text" name = "teacherName" style=" border-radius:5px;margin-right:50px;width:160px;height:32px; border-width:2px;border-style:solid;border-color:#d0d0d0" required autofocus/>
...
<select name="collegeSelect" style="border-radius:5px;margin-right:50px;border-radius:5px;width:160px;height:32px;">
 ...
 <tr>
        ...
        <td colspan="4" align="center" style="border-radius:5px;">
            ...
            <a href = "AdminIndex1.jsp"><input type="button" style="cursor:pointer;border-radius:5px;background:#D2E9FF;width:50px;height:30px;" value="返回"></a>
