...
<div id="divMain" style="border-radius:5px;">
	...
	<div id="divQuestion" style="border-radius:5px;">
				...
				for(HomeworkView temp : list)
				{
			        ...
			        else if(temp.getQuestionType() == 2)
			        {
			            out.println("<tr><td>"
                        					...
                        					"("+"分值:"+temp.getExpr1()+")"+
                        					"&nbsp&nbsp&nbsp得分:<input readonly size='1' type='text' name='scores'value='"+ temp.getQuestionScore()+"'></input></td></tr>");
                       out.println("<tr><td>学生答案:<br><textarea border-radius='5px;' readonly rows='10' cols='100' type='text'>" + temp.getStudentAnswer() +"</textarea></td></tr>");
                       out.println("<tr><td>正确答案:<br><textarea border-radius='5px;' readonly rows='10' cols='100' type='text'>" + temp.getQuestionRightAnswer() +"</textarea></td></tr>");
                        i++;
			        }
				}
			%>
		...
		<table id="tableButtons">
			<tr>
				<td id="tdBack"><a href="StudentIndex.jsp">返回</a></td>
			</tr>
		</table><%-- tableButtons --%>
		</from>
</div>
