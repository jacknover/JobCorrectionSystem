...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
 ...
 <body>
  <%
      ...
      int currentPage = 1;
      int allPage = -1;
      ArrayList<StudentAssignment> doneTeacherAssignments = (ArrayList) session.getAttribute("doneTeacherAssignments");
...
<div style="margin-top:10px;float:left;"><input type="text" placeholder=<%=session.getAttribute("teacherName")%> style="border-radius:5px;margin-left:550px;float:left;height:20px;width:100px; text-align:center; border: 2px solid #f2f2f2;" /></div>
...
<form id="form1" name="form1" method="post" action="searchDoneTeacherAssignment">
<input type="text" placeholder="作业ID" name="homeworkID" style="border-radius:5px;margin-top:10px;margin-left:50px;float:left;height:25px;width:100px; text-align:center; border: 2px solid #f2f2f2;" />
...
<br/>
	<tr>
			...
			<td colspan="1"border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">成绩</td>
			<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">操作</td>
				...
				<%
                		       if(pages != null)
                                {
                                 ...
                                 if(doneTeacherAssignments == null){}
                                 else if(doneTeacherAssignments != null){
                                    allPage = (doneTeacherAssignments.size() - 1)/pageSize + 1;
                                    int left = pageSize*(currentPage - 1);
                                    int right = doneTeacherAssignments.size() < pageSize*currentPage ? doneTeacherAssignments.size() : pageSize*currentPage;
                         ...
                         %>
                        		...
                        		<tr>
                    			<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getHomeworkID()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getHomeworkDescribe()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getCourseName()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getStudentID()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getStudentName()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getClassName()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=doneTeacherAssignments.get(i).getAssignScore()%></td>
                        		<td colspan="1" border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF">
                        		<a href="<%=request.getContextPath()%>/teacherWatchHomework?studentID=<%=doneTeacherAssignments.get(i).getStudentID()%>&homeworkID=<%=doneTeacherAssignments.get(i).getHomeworkID()%>&homeworkName=<%=doneTeacherAssignments.get(i).getHomeworkDescribe()%>"><font color="#FF5151">查看作业</font></a>
                        		<a href="<%=request.getContextPath()%>/homeworkDetail?className=<%=doneTeacherAssignments.get(i).getClassName()%>&homeworkID=<%=doneTeacherAssignments.get(i).getHomeworkID()%>&homeworkName=<%=doneTeacherAssignments.get(i).getHomeworkDescribe()%>"><font color="#FF5151">查看详情</font></a>
                    			</tr>
                		<%
                		       }}
                		%>
  ...
  <tr>
                                                        ...
                                                        <ul class="pagination" style="border-radius:5px;">
                                                          <li><a href="TeacherIndex.jsp?pages=<%= currentPage == 1? currentPage : currentPage - 1%>">上一页</a></li>
                                                           <%for(int i = 1; i <= allPage; i++){
                                                               out.print("<li><a href = TeacherIndex.jsp?pages=" + i + ">" + i + "</a></li>");
                                                               }%>
                                                          <li><a href="TeacherIndex.jsp?pages=<%= currentPage == allPage? allPage : currentPage + 1%>">下一页</a></li>
                                                        </ul>
                                                        </td>
                                                        </tr>
</div>
