 ...
 <body>
      <%
        	if(request.getAttribute("msg") != null){
        		out.print("<script> alert(\"教师添加成功!\"); </script>");
        	}
        	if(request.getAttribute("delete") != null){
               out.print("<script> alert(\"教师删除成功!\"); </script>");
            }
          int pageSize = 7;
          int currentPage = 1;
          int allPage = -1;
          ArrayList<TeacherView> teachers = (ArrayList) session.getAttribute("teachers");
...
<div id="na" style="margin-top:10px;">
	<ul>
...
<form id="form1" name="form1" method="post" action="searchTeacher">
<input type="text" placeholder="教师ID" name = "teacherID" style="margin-top:10px;margin-left:80px;border-radius:5px;float:left;height:25px;width:100px; text-align:center; border: 2px solid #f2f2f2;" />
<input type="text" placeholder="教师名" name = "teacherName" style="margin-top:10px;border-radius:5px;float:left;height:25px;width:100px;text-align:center;  border: 2px solid #f2f2f2;" />
...
<br/>
	<tr>
	        <td border='1' width="120" height="30" style="margin-left:15px;text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">教师ID</td>
			<td border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">教师名</td>
			...
			<td border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">学院</td>
			...
			<td border='1' width="120" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#F0F0F0">操作</td>
						...
						<%
                                        		       if(pages != null)
                                                        {
                                                         ...
                                                         if(teachers == null){}
                                                            ...
                                                            allPage = (teachers.size() - 1)/pageSize + 1;
                                                            int left = pageSize*(currentPage - 1);
                                                            int right = teachers.size() < pageSize*currentPage ? teachers.size() : pageSize*currentPage;
                                                 ...
                                                 %>
                                                		...
                                                		<tr >
                                            			<td border='1' width="96" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=teachers.get(i).getTeacherID()%></td>
                                                		<td border='1' width="96" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=teachers.get(i).getTeacherName()%></td>
                                                		<td border='1' width="96" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=teachers.get(i).getCollegeID()%></td>
                                                		<td border='1' width="96" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=teachers.get(i).getCollegeName()%></td>
                                                		<td border='1' width="96" height="30" style="text-align:center;border-radius:5px;border-style:solid;border-color:#777777#dddddd#dddddd#777777;background:#ECF5FF"><%=teachers.get(i).getActiveFlag()%></td>
                                                    	...
                                                    	<a href="<%=request.getContextPath()%>/deleteTeacher?teacherID=<%=teachers.get(i).getTeacherID()%>"><font color="red">删除</font></a>
                                                		</td>
                                            			</tr>
                                        		<%
                                        		       }}
...
<tr>
                                ...
                                <ul class="pagination" style="border-radius:5px;">
                                  <li><a href="AdminIndex1.jsp?pages=<%= currentPage == 1? currentPage : currentPage - 1%>">上一页</a></li>
                                   <%for(int i = 1; i <= allPage; i++){
                                       out.print("<li><a href = AdminIndex1.jsp?pages=" + i + ">" + i + "</a></li>");
                                       }%>
                                  <li><a href="AdminIndex1.jsp?pages=<%= currentPage == allPage? allPage : currentPage + 1%>">下一页</a></li>
                                </ul>
                                </td>
                                </tr>
