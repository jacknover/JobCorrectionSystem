...
<div id="divMain" style="border-radius:5px;">
	...
	<form id="form1" name="form1" method="post" action="submitHomework">
	<div id="divQuestion" style="border-radius:5px;">
				...
				for(HomeworkView temp : list)
				{
			        ...
			        if(temp.getQuestionType() == 1)
			        {
			            out.println("<tr><td>"
                        					...
                        					"("+"分值:"+temp.getExpr1()+")"+
                        					"&nbsp&nbsp&nbsp答案:<input size='1' type='text' name='answers' value='"+temp.getStudentAnswer()+"'></input></td></tr>");
			        ...
			        else if(temp.getQuestionType() == 2)
			        {
			            out.println("<tr><td>"
                        					...
                        					"("+"分值:"+temp.getExpr1()+")"+
                        					"</td></tr>");
                       out.println("<tr><td><textarea rows='10' cols='100' type='text' name='answers'>" + temp.getStudentAnswer() +"</textarea></td></tr>");
                        i++;
			        }
				}
			%>
		...
		<table id="tableButtons" style="border-radius:5px;">
			<tr>
				<td id="tdSub"><input type="submit" value="保存作业" ></td>
				<td id="tdRe"><input type="reset" value="重置"></td>
				<td id="tdBack"><a href="StudentIndex1.jsp">返回</a></td>
			</tr>
		</table><%-- tableButtons --%>
		</from>
</div><%-- divMain --%>
